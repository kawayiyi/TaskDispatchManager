...
namespace TaskDispatchManager.Common
{
    ...
    public class TypeConvertUtils
    {
        ...
        public static int SafeInt32(object objNum)
        {
            ...
            if (ValidatorUtils.IsNumeric(strNum))
            {
        ...
        /// <returns></returns>
        /// <remarks>冯瑞 2011-07-27 14:33:49</remarks>
        ...
        /// <returns></returns>
        /// <remarks>冯瑞 2011-07-27 14:33:57</remarks>
        ...
        /// <summary>
        /// 将sring（eg:1,2,3）转换成List int
        /// </summary>
        /// <param name="input"></param>
        /// <returns></returns>
        /// <reremarks>Dennis Feng by 2014-04-23</reremarks>
        public static List<int> StringToListInt(string input)
        {
            List<int> result = new List<int>();
            if (!string.IsNullOrEmpty(input))
            {
                string[] temp = StringUtils.SplitString(input, ",");
        ...
        public static string DToAny(BigInteger num, int type)
        {
            ...
            {
                BigInteger valueOf = new BigInteger(type);
                str = DToAny(BigInteger.Divide(num, valueOf), type);
                return str + digit[(int)BigInteger.ModPow(num,1, valueOf)];
            }
